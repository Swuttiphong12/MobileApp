...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClickToggle(View v){
        ...
        } else if (id == R.id.toggleBtn2) {
            if (toggleBtn2.isChecked())
                Toast.makeText(this, "Bluetooth Toggle 1 On!", Toast.LENGTH_SHORT).show();
            else
                Toast.makeText(this, "Bluetooth Toggle 1 Off!", Toast.LENGTH_SHORT).show();
        }
    }
