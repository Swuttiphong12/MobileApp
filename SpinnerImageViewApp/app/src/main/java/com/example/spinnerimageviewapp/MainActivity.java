package com.example.spinnerimageviewapp;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    private String[] inputs = { "Pakistan", "Iran", "China", "India", "Thailand", "U.A.E.",
            "Yemen", "Palestine", "America", "Australia", "Turkey", "England",
            "France", "Greece"};
    private String [] names = {
            "deosaid_land", "dudipatsar_lake", "rama_lake"};
